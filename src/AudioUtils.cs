...
public static class AudioUtilities
{
    ...
    private static ISimpleAudioVolume GetVolumeObject(int pid) 
    {
        ...
        for (int i = 0; i < count; i++) 
        {
            ...
            IAudioSessionControl2 ctl = ctl1 as IAudioSessionControl2;
            int cpid;
    ...
    private static IAudioSessionManager2 GetAudioSessionManager()
    {
        ...
        // win7+ only
        object o;
        if (speakers.Activate(typeof(IAudioSessionManager2).GUID, CLSCTX.CLSCTX_ALL, IntPtr.Zero, out o) != 0 || o is null)
            return null;
